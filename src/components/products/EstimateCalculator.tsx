...
export default function EstimateCalculator({ options, defaultCool = false }: EstimateCalculatorProps) {
  ...
  return (
    <div className="bg-stone-white/95 backdrop-blur-sm p-6 shadow-lab-lg border-t-4 border-eolica-green">
      <h3 className="font-mono text-xs tracking-widest text-warm-gray-500 mb-6 flex items-center gap-2">
        ESTIMATE <span className="font-serif">ー送料込・簡易見積もりー</span>
      </h3>
      ...
      {/* Result */}
      <div className="bg-warm-gray-50/50 p-6 border border-warm-gray-100">
